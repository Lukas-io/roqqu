class RoqquAssets {
  ...
  static const String _images = "$_root/images";
  static const String _svg = "$_root/svg";

  //Images
  static const String logoImage = "$_images/logo.png";
  static const String crownImage = "$_images/crown.png";
  static const String bitcoinImage = "$_images/bitcoin.png";
  static const String cardanoImage = "$_images/cardano.png";
  ...
  static const String proBadge = "$_images/pro_badge.png";

  //Svg
  static const String dropdownSvg = "$_svg/dropdown.svg";
  static const String headphonesSvg = "$_svg/headphones.svg";
  ...
  static const String proTraderSvg = "$_svg/pro_trader.svg";
